...
export default function MembersPanel({
  ...
  return (
    <aside className="p-8 border-l border-neutral-700 w-96 overflow-auto scrollbar-thin">
      {members.map((member) => (
        <div key={member.id} className="flex gap-2 items-center">
          ...
          <div>
            <p>{member.name} {folder.createdBy.id === member.id && <i className="text-neutral-700">Owner</i>}</p>
