...
import NotificationsPopup from "@/components/popups/notifications"
...
export default function NotificationButton() {
  ...
  return (
    <>
      ...
      {isNotificationPopupVisible && <NotificationsPopup onClose={() => setIsNotificationPopupVisible(false)} />}
    </>
  )
}